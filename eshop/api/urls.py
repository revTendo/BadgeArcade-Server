...
urlpatterns = [
    ...
    path('<str:country>/title/<str:tid>/aocs/!purchase_ctr', views.purcahse_aoc, name="purchaseaoc"),
    ...
    path('my/tax_location/!put', views.empty, name="taxloc_put"),
    path('my/transactions', views.transactions, name="transactions"),
    path('my/votes', views.votes, name="votes"),
    path('my/votes/!put', views.vote, name="vote_put"),
